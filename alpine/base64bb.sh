#!/usr/bin/env bash
# fallback base64 implementation that works with busybox
# source: https://github.com/mateusza/shellscripthttpd/blob/master/base64.sh

encode(){
    # using od to output a string in hex		http://www.commandlinefu.com/
